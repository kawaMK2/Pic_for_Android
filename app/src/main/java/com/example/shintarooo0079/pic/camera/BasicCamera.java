...
public class BasicCamera {
    ...
    public final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            createCameraPreviewSession(400, Long.valueOf("34000"));
        }
    ...
    public void configCamera(Integer sensitivity, Integer expose) {
        mCaptureSession.close();
        mCaptureSession = null;
        createCameraPreviewSession(sensitivity, Long.valueOf(expose.toString()));
    }
    ...
    private void createCameraPreviewSession(final Integer sensorSensitivity, final Long sensorExposeTime) {
        this.sensorSensitivity = sensorSensitivity;
        this.sensorExposeTime = sensorExposeTime;
        try {
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                mPreviewRequestBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, sensorExposeTime);
